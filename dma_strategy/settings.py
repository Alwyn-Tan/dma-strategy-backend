...
SECRET_KEY = os.getenv('SECRET_KEY', 'dev-key-for-local-development')
...
ROOT_URLCONF = 'dma_strategy.urls'
...
WSGI_APPLICATION = 'dma_strategy.wsgi.application'
