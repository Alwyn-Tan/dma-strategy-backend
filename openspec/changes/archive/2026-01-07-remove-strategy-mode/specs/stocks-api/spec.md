...
- FROM: `### Requirement: Advanced strategy mode parameters`
- TO: `### Requirement: Performance query parameters`
- FROM: `### Requirement: Meta assumptions include strategy configuration`
- TO: `### Requirement: Meta assumptions disclose enabled features`
